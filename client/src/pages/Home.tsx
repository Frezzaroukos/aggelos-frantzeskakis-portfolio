...
const stories: Record<Language, Record<string, ProjectStory>> = {
  en: {
    ...
    anabasis: {
      ...
      title: "Anabasis",
      summary: "Weighted calisthenics and skill-progression tracker. Offline-first PWA with a native desktop build and an optional Rust sync backend — strict TypeScript, bilingual.",
      detail: "Built for training that happens in a gym with no signal. Everything is stored locally in IndexedDB and works in airplane mode; create an account and it follows you across phone, web and the desktop app — row-level sync over an Axum + SQLite backend, argon2id auth, a unique admin.",
      facts: ["TypeScript", "Rust / Axum", "Tauri desktop", "Offline-first sync"],
      badge: "Live",
  ...
  el: {
    ...
    anabasis: {
      ...
      title: "Anabasis",
      summary: "Tracker για weighted calisthenics και εξέλιξη σε skills. Offline-first PWA με native desktop έκδοση και προαιρετικό Rust backend για sync — strict TypeScript, δίγλωσσο.",
      detail: "Φτιαγμένο για προπόνηση σε γυμναστήριο χωρίς σήμα. Όλα αποθηκεύονται τοπικά σε IndexedDB και δουλεύουν σε λειτουργία πτήσης· φτιάχνεις λογαριασμό και σε ακολουθεί σε κινητό, web και desktop app — row-level sync πάνω σε Axum + SQLite, argon2id auth, μοναδικός admin.",
      facts: ["TypeScript", "Rust / Axum", "Tauri desktop", "Offline-first sync"],
      badge: "Live",
